#ifndef _DATABASE_ITEM_INFO_
#define _DATABASE_ITEM_INFO_
...
namespace svr {
    ...
    struct item 
    {
        ...
        std::string m_description = "This item has no description. Message Eobard Thawne#0084 to add it.";
